...
outputSR = arcpy.SpatialReference(54002) # number between parentheses is the "well  known" id of the spatial reference 
# can find the well known id (WKID) in arcgis
